...
class PostAuthorController extends Controller
{
    public function index()
    {
        ...
        $posts = Post::orderBy('date', 'asc')->where('username', $user->username)->get();
    ...
    public function store(Request $request)
    {
        ...
        return to_route('author.post')->with('success', 'Berhasil membuat post');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('author.post')->with('success', 'Berhasil mengubah post');
    }
