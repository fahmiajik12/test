...
$("#postId").on("change", function () {
    ...
    // check id
    $.ajax({
        url: "/check-post-id-editor-choice/" + id,
        type: "GET",
        dataType: "json",
...
$("#orderNumber").on("change", function () {
    ...
    // check number
    $.ajax({
        url: "/check-order-number-editor-choice/" + number,
        type: "GET",
        dataType: "json",
        success: function (response) {
            Swal.close();
...
$("#editOrderNumber").on("change", function () {
    ...
    // check number
    $.ajax({
        url: "/check-edit-order-number-editor-choice/" + id + "/" + number,
        type: "GET",
        dataType: "json",
        success: function (response) {
            Swal.close();
...
$("#editPostId").on("change", function () {
    ...
    // check id
    $.ajax({
        url: "/check-post-edit-id-editor-choice/" + id + "/" + idHeadline,
        type: "GET",
        dataType: "json",
        success: function (response) {
